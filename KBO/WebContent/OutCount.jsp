...
<body>
	...
	<span class="label" style="text-decoration:none;padding:3px;font-size:12px;padding-left:2px;padding-right:2px;border:1px solid white;color:#3F0099;color:white;">종합</span>
	</a> 
	...
	<span class="label" style="text-decoration:none;padding:3px;font-size:12px;padding-left:2px;padding-right:2px;border:1px solid white;background:#3F0099; background:white;">투구</span>
	</a> 
	</div>
		<div class="container">
	...
	<option value="ERAP.jsp">평균자책점(ERA)</option>
	<option value="Win.jsp">승</option>
	<option value="Loss.jsp">패</option>
	<option value="SV.jsp">세이브</option>
	<option value="HLD.jsp">홀드</option>
	<option value="OutCount.jsp">이닝</option>
	</select>
	</div>
	<%
		String url = "http://www.statiz.co.kr/stat.php?mid=stat&re=1&ys=2022&ye=2022&se=0&te=&tm=&ty=0&qu=auto&po=0&as=&ae=&hi=&un=&pl=&da=1&o1=OutCount&o2=OutCount&de=1&lr=0&tr=&cv=&ml=1&sn=30&si=&cn=";
	Document doc = null;
